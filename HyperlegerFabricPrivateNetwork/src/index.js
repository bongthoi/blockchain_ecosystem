...
if (cfenv.getAppEnv().isLocal == true)
  { var server = app.listen(3002, function() {console.log('Listening locally on port %d', server.address().port);}); }
  else
  { var server = app.listen(3002, function() {console.log('Listening remotely on port %d', server.address().port);}); }
/**
